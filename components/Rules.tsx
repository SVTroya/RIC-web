...
function Rules({onClose}: Props) {
  return (
    <div className='flex flex-col gap-4 md:gap-6'>
      ...
      <div className='rule'>
        <h3 className='rule_text_header'>GAME ROUNDS</h3>
        <p>
      ...
      <div className='rule'>
        <h3 className='rule_text_header'>ROLLING DICE</h3>
        <p>
          ...
          <i className='rule_text_note'>Note: Stations (squares) allow you to connect a Railway Route to a Highway
            Route. Overpasses allow the two to cross without being connected to each other.</i>
        </p>
      </div>

      <div className='rule'>
        <h3 className='rule_text_header'>DRAWING ROUTES</h3>
        <p>
          After the dice roll, all players must draw the Routes on their boards at the same
          time. There are a few drawing rules you need to follow:</p>
          <ol className='list-decimal  list-inside'>
            <li>
              Each Route you draw must be connected on at least one side to either one of
              the exists, or a pre-existing Route, If you can’t connect a Route, you can’t draw
              it.
            </li>
            <li>
              You must draw all four Routes shown on the dice each round, if possible (and
              each Route showing can only be drawn once).
            </li>
            <li>
              You can’t draw Routes in a way that directly connects Railways to Highways
              (you need a Station to do that).
            </li>
          </ol>
        <p><i className='rule_text_note'>Important: When drawing Routes, you can freely rotate and/or reverse the pattern
            you see on the die.</i></p>
      </div>

      <div className='rule'>
        <h3 className='rule_text_header'>USING SPECIAL ROUTES (JUNCTIONS)</h3>
        <p>
      ...
      <div className='rule'>
        <h3 className='rule_text_header'>SPECIAL BUILDINGS (CHALLENGE ONLY)</h3>
        <p>
          ...
          There are 3 kinds of Special Buildings:</p>
          <ul className='list-disc list-inside'>
            <li>
              <span className='font-bold'>Factory:</span> You activate a Factory when you draw a Route with at least one
            ...
            <li>
              <span className='font-bold'>Village:</span>You activate a Village when you draw a Route with a Station in
              its
            ...
            <li>
              <span className='font-bold'>University:</span> You activate a University when you draw a Route with at least
          ...
          <i className='rule_text_note'>Note: Drawing Routes obtained thanks to the effect of a Factory or a University
          ...
          <p><i className='rule_text_note'>Note: When playing with Expansions which may erase routes from your board, if
            ...
            again by drawing another route in its space.</i></p>
      </div>

      <div className='rule'>
        <h3 className='rule_text_header'>CHECKING GOALS (CHALLENGE ONLY)</h3>
        <p>
      ...
      <div className='rule'>
        <h3 className='rule_text_header'>END OF THE ROUND</h3>
        <p>
      ...
      <div className='rule'>
        <h3 className='rule_text_header'>END OF THE GAME</h3>
        <p>
          ...
          Table.
          <i className='rule_text_note'>Note: If you are playing with an Expansion, mark any additional points on the
            Expansion space of your scoring board.</i>
          <br/>
